...
#However, at this point we have not written any code to verify that a word given by a player obeys the rules 
#of the game. A valid word is in the word list; and it is composed entirely of letters from the current hand.
# Implement the isValidWord function.
#
#Testing: Make sure the test_isValidWord tests pass. In addition, you will want to test your implementation 
#by calling it multiple times on the same hand - what should the correct behavior be?
...
def isValidWord(word, hand, wordList):
    ...
    for letter in word:
        ...
        if dict[letter]==0:
            dict.pop(letter)
    if word in wordList and a==True:
        return True
    else:
        return False
